        ...
        if ($this->_HeronModules === null) {
            ...
            if ($allowList) {
                ...
                foreach ($moduleList as $name) {
                    if (strpos($name, 'Heron_') === false) {
                        continue;
                    }

                    $this->_HeronModules[] = $name;
                }
            }
        }

        return $this->_HeronModules;
    }
}
