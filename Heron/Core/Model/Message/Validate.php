...
namespace Heron\Core\Model\Message;

use Magento\Framework\Notification\MessageInterface;
use Magento\Framework\Phrase;
use Magento\Framework\UrlInterface;
use Heron\Core\Helper\Validate as ValidateHelper;

/**
 * Class Validate
 * @package Heron\Core\Model\Message
 */
class Validate implements MessageInterface
{
    ...
    {
        return hash('md5', 'Heron_VALIDATE_MESSAGE');
    }
    ...
    public function getText()
    {
        ...
        return __(
            'One or more Heron extensions are not validated. Click <a href="%1">here</a> to validate them.',
            $url
        );
    }
