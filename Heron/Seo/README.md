...
**Heron SEO All-in-One for Magento 2** is a bundle of outstanding features that are auto-active when you install it from Heron without any code modifications. It is also friendly with your store if you need to insert meta keywords and meta descriptions for your product. It will do perfectly for your better SEO.

[![Latest Stable Version](https://poser.pugx.org/Heron/magento-2-seo-extension/v/stable)](https://packagist.org/packages/Heron/magento-2-seo-extension)
[![Total Downloads](https://poser.pugx.org/Heron/magento-2-seo-extension/downloads)](https://packagist.org/packages/Heron/magento-2-seo-extension)
...
- [Installation guide](https://www.Heron.com/install-magento-2-extension/)
- [User Guide](https://docs.Heron.com/seo-m2/index.html)
- [Download from our Live site](https://www.Heron.com/magento-2-seo-extension/)
- [Get Free Support](https://github.com/Heron/magento-2-seo/issues)
- Get premium support from Heron: [Purchase Support package](https://www.Heron.com/magento-2-extension-support-package/)
- [Contribute on Github](https://github.com/Heron/magento-2-seo)
- [Releases](https://github.com/Heron/magento-2-seo/releases)
...
```
composer require Heron/magento-2-seo-extension Heron/module-sitemap
php bin/magento setup:upgrade
```

### Install Package from copy-paste package

Download the latest version at [Heron.com](https://www.Heron.com/magento-2-seo-extension/)
then follow [installation guide](https://www.Heron.com/install-magento-2-extension/)

## 3. SEO FAQs

#### Q: I got error: `Heron_Core has been already defined`
A: Read solution: https://github.com/Heron/module-core/issues/3

#### Q: My site is down
A: Please follow this guide: https://www.Heron.com/blog/magento-site-down.html
...
Improve your SEO for Magento 2 site. Use **Heron SEO All in One** to automatically optimize your site for Search Engines.
**Heron SEO extension** will automatically optimize and greatly improve the performance of your Magento-based store in Search Engines. Magento 2 is great SEO-ready out-of-the-box that is really good for SEO. However it still needs some craftiness to be improved in a few areas.

Heron SEO module will support a list of new useful tools and settings that help you have own all the technical optimization with automatically optimizing and inserting the meta tags and link elements that Google or other Search Engines like so much:

### Stop Duplicating Content SEO

By automatically preventing the duplicate content problem, **Heron SEO extension** will avoid your site from being affected badly to the search ranking or caused the traffic loss, and as a result, boost the SEO performance significantly.
...
**Heron SEO All-in-One** will **add schema structured data to Magento 2 store** automatically without configuration to help Search engines display your web pages better and more attractive.
...
A huge advantage when you have Megaplaza SEO extension is that it’s fully supported by [Layered Navigation](https://www.Heron.com/magento-2-layered-navigation-extension/) to make the SEO performance even better.
...
- Fully compatible with Heron extensions			
...
Firstly, we will familiar with the module via the list of the configuration. Login as Admin account, go to the path `Heron > SEO > Settings`.
...
-   Allow applying Organization Information that describes the results
    ...
    [guide](https://Heron.freshdesk.com/support/solutions/articles/6000122360).
...
`www.Heron.com > Magento 2 Extensions > Better SEO`. If you really
...
**Heron extensions on Magento Marketplace, Github**


☞ [Magento 2 One Step Checkout extension](https://marketplace.magento.com/Heron-magento-2-one-step-checkout-extension.html)

☞ [Magento 2 SEO Module](https://marketplace.magento.com/Heron-magento-2-seo-extension.html)

☞ [Magento 2 Blog extension](https://marketplace.magento.com/Heron-magento-2-blog-extension.html)

☞ [Magento 2 Layered Navigation extension](https://marketplace.magento.com/Heron-layered-navigation-m2.html)

☞ [Magento One Step Checkout](https://github.com/magento-2/one-step-checkout)

☞ [Magento 2 Blog on Github](https://github.com/Heron/magento-2-blog)

☞ [Magento 2 Social Login on Github](https://github.com/Heron/magento-2-social-login)

☞ [Magento 2 SEO on Github](https://github.com/Heron/magento-2-seo)

☞ [Magento 2 SMTP on Github](https://github.com/Heron/magento-2-smtp)

☞ [Magento 2 Product Slider on Github](https://github.com/Heron/magento-2-product-slider)
...
Rebuilt Heron SEO Standard edition. 
...
+ Add Heron_Blog posts meta data template
...
- Edit composer.json to require Heronmodule-core instead of Heroncore-m2
...
- [Magento 2 Product slider](https://github.com/Heron/magento-2-product-slider)
- [Magento 2 GDPR](https://github.com/Heron/magento-2-gdpr)
- [Magento 2 popup extension](https://github.com/Heron/magento-2-better-popup)
- [Magento 2 Reports extension](https://github.com/Heron/magento-2-reports)
- [Magento 2 social login](https://github.com/Heron/magento-2-social-login)
- [Magento 2 blog](https://github.com/Heron/magento-2-blog)
- [Magento 2 Layered Navigation](https://github.com/Heron/magento-2-ajax-layered-navigation)
- [Magento 2 security extension](https://github.com/Heron/magento-2-security)
